...
#### <a name='undolog'></a>undo log 撤销过程具体是怎么撤销的?
...
#### <a name='MySQL-1'></a>设计MySQL的表结构要考虑什么问题？
